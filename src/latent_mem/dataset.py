...
from latent_mem.configs import DataConfig


class SpatiaLMDBDataset(Dataset):
    """
    Dataset for Spatia training with scene point cloud conditioning.
...
def spatia_collate_fn(batch):
    """
    Custom collate function for Spatia dataset.
