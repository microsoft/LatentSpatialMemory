...
from latent_mem.inference.spatia_latent_mem import (
    SpatiaOriginalLatentMemConfig,
    SpatiaOriginalLatentMemPipeline,
    load_lora_checkpoint,
    load_vace_checkpoint,
    validate_original_spatia_pipe,
)
from latent_mem.spatia.wan_video_new import WanVideoPipeline


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run original Spatia inference with latent memory conditioning."
    )
...
def build_inference_config(args: argparse.Namespace) -> SpatiaOriginalLatentMemConfig:
    return SpatiaOriginalLatentMemConfig(
...
def load_pipeline_from_args(
    ...
    *,
    ...
    validate_original_spatia_pipe(pipe)
    ...
    return SpatiaOriginalLatentMemPipeline(pipe, build_inference_config(args))
